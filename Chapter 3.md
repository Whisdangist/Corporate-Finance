...
财务报表的另一重要用途是**安排财务计划**  
多数财务计划模型的**结果**生成**预测财务报表**  
财务计划以财务报表的形式**表达**，财务报表是用于概括公司未来预计财务状况的**形式**

### 3.4.1 一个简单的财务计划模型

- 假设**所有项目**随着**销售额**变动而**成比例**变动^[总资产也随销售额成比例变动]

### 3.4.2 销售百分比法 (percentage of sales)

- 假设**销售利润率**不变
- 假设该公司的**股利支付率**不变

> 股利支付率 = 现金股利 / 净利润
> 留存比率^[也叫利润再投资率] = 1 - 股利支付率

> 资本密集率 = 总资产 / 销售额
> 资本密集率 = 1 / 总资产周转率

> 外部融资需要量(EFN) = (资产 - 自然增长的负债) * Δ销售额 / 销售额 - PM^[PM为销售利润率] * 预计销售额 * b^[b为留存比率]

## 3.5 外部融资与增长

我们之所以关注增长，不是因为增长是一个合适的目标，而是因为增长是考察**投资决策**与**融资决策**之间关系的一个便捷途径

### 3.5.1 EFN与增长

公司的现金冗余或现金短缺取决于公司的增长

### 3.5.2 融资政策与增长

1. 内部增长率

**内部增长率**：在**没有任何外部融资**^[此时公司的增长会带来财务杠杆比例的下降]的情况下公司可能实现的最大增长率

> 内部增长率 = ROA * b / (1 - ROA * b)
> 内部增长率 = 留存收益 / (期末总资产 - 留存收益)
> 内部增长率 = 留存收益 / 期初总资产

2. 可持续增长率
**可持续增长率**：在**没有外部股权融资**且保持**负债-权益比不变**的情况下可能实现的最高增长率

> 可持续增长率 = ROE * b / (1 - ROE * b)
> 可持续增长率 = 留存收益 / (期末总权益 - 留存收益)
> 可持续增长率 = 留存收益 / 期初总权益

3. 增长的决定因素

ROE * b = 销售利润率 * 总资产周转率 * 权益乘数 * 留存比率

- **销售利润率**：提高公司内部生成资金的能力
- **总资产周转率**：提高每单位资产能够但来的销售额
- **融资政策**：提高公司财务杠杆
- **股利政策**：提高留存比率，增加内部股权资金

### 3.5.3 关于可持续增长率计算的一个说明

## 3.6 关于财务计划模型的注意事项

财务计划模型并非总是提出正确的问题，主要原因在于其以来于**会计关系**而非**财务关系**。特别是，公司价值的三个最基本的要素没有被考虑在内，即**现金流量**的**规模**、**风险**、及**时间性**。
